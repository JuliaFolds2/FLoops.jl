...
@doc let path = joinpath(dirname(@__DIR__), "README.md")
    ...
    doc = replace(
        doc,
        "https://juliafolds2.github.io/FLoops.jl/dev/tutorials/sequential/" => "@ref tutorials-sequential",
    )
    doc = replace(
        doc,
        "https://juliafolds2.github.io/FLoops.jl/dev/tutorials/parallel/#tutorials-executor" => "@ref tutorials-executor",
    )
    doc = replace(
        doc,
        "https://juliafolds2.github.io/FLoops.jl/dev/tutorials/parallel/" => "@ref tutorials-parallel",
    )
    doc
end FLoops
